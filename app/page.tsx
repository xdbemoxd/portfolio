...
export default function Home() {
  return (
    <div className="grid place-content-center mt-10 max-sm:mt-5">
      ...
      <div className="text-center bg-blue-500/15 m-10 p-4 mx-auto rounded-full shadow-lg shadow-blue-500/30 max-sm:p-0.5">
      ...
      <div className="">
        ...
        <h1 className="text-5xl font-bold m-1 max-sm:text-2xl max-sm:text-center"> Codigo </h1>
